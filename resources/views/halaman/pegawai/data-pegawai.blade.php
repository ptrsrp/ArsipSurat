    ...
    <div class="col-md-12">
        <div class="card">
            <div class="card-header">
                ...
                <a href="{{ route('tambah.pegawai')}}" class="btn btn-success float-right">Tambah <i
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="text-center">
                                    {{-- <form action="{{ route('hapus.pegawai', $item->id) }}" method="post" onsubmit="return confirm('Yakin Hapus Data?')">
                                        @csrf
                                        @method('DELETE')
